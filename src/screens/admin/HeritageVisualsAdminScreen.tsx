...
const styles = StyleSheet.create({
  ...
  cardSectionTitle: { color: COLORS.gold, fontSize: 11, fontWeight: '700', letterSpacing: 1 },
  selectorBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  modalContent: {
    width: '100%', maxWidth: 450, backgroundColor: '#FFFFFF',
  ...
  monumentOptionActive: { backgroundColor: 'rgba(30, 58, 138, 0.08)' },
  ...
  cancelModalBtn: { paddingHorizontal: SPACING.md, paddingVertical: 10, borderRadius: BORDER_RADIUS.md, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#E2E8F0' },
  cancelModalText: { color: COLORS.textSecondary, fontSize: 12, fontWeight: '600' },
  confirmUploadBtn: { paddingHorizontal: SPACING.md, paddingVertical: 10, borderRadius: BORDER_RADIUS.md, backgroundColor: COLORS.primary },
  confirmUploadText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700' },

  // Full Viewer Overlay
  fullViewerOverlay: { flex: 1, backgroundColor: 'rgba(15, 23, 42, 0.95)', justifyContent: 'center', alignItems: 'center' },
