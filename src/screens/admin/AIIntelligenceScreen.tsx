...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: COLORS.textSecondary, fontSize: 10, marginTop: 2, fontWeight: '600', textTransform: 'uppercase' },
  ...
  activeUserAvatarText: { color: COLORS.primary, fontSize: 18, fontWeight: '700' },
  ...
  chartVal: { color: COLORS.primary, fontSize: 11, fontWeight: '700' },
  barTrack: { width: 14, height: 75, backgroundColor: '#F1F5F9', borderRadius: 4, justifyContent: 'flex-end', overflow: 'hidden' },
  barFill: { backgroundColor: COLORS.primary, borderRadius: 4, width: '100%' },
  chartDay: { color: COLORS.textSecondary, fontSize: 10, fontWeight: '600' },
  perfCard: {
    backgroundColor: '#FFFFFF',
    borderRadius: BORDER_RADIUS.lg,
    borderWidth: 1,
  ...
  perfName: { color: COLORS.textPrimary, fontSize: 14, fontWeight: '700', flex: 1 },
  perfStats: { flexDirection: 'row', flexWrap: 'wrap', gap: SPACING.lg, marginTop: 4 },
  perfStat: { alignItems: 'center' },
  perfStatValue: { color: COLORS.primary, fontSize: 14, fontWeight: '700' },
