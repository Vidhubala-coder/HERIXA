...
const styles = StyleSheet.create({
  container: { flex: 1, padding: SPACING.md, backgroundColor: '#FAFAFA' },
  ...
  toggleBtnActive: { backgroundColor: 'rgba(30, 58, 138, 0.08)' },
  ...
  roleBadgeAdmin: { backgroundColor: 'rgba(30, 58, 138, 0.1)' },
  roleBadgeUser: { backgroundColor: 'rgba(100, 116, 139, 0.1)' },
  roleBadgeText: { fontSize: 9, fontWeight: '800' },
  roleTextAdmin: { color: COLORS.primary },
  roleTextUser: { color: '#64748B' },
  viewBtn: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6, backgroundColor: 'rgba(30, 58, 138, 0.08)' },
  ...
  avatarTextLarge: { color: COLORS.primary, fontSize: 18, fontWeight: '800' },
  ...
  statBoxValue: { color: COLORS.primary, fontSize: 14, fontWeight: '800' },
  ...
  timelineLine: { flex: 1, width: 1, backgroundColor: '#E2E8F0', marginTop: 4 },
