...
export const logEvent = async (
  event:
    ...
    | 'PROTOCOL_UPDATED'
    | 'PROTOCOL_AI_EXTRACTED'
    | 'PROTOCOL_PUBLISHED'
    | 'HERITAGE_STORY_CREATED'
    | 'HERITAGE_STORY_UPDATED'
    | 'HERITAGE_STORY_AI_GENERATED'
    | 'HERITAGE_SCRIPT_GENERATED'
    | 'HERITAGE_VIDEO_GENERATED'
    | 'HERITAGE_VIDEO_UPLOADED'
    | 'HERITAGE_STORY_PUBLISHED'
    | 'HERITAGE_STORY_UNPUBLISHED',
